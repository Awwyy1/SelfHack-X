      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 mt-4 justify-center lg:justify-start">
            <button 
  onClick={onLaunch}
  className="group relative px-10 py-5 bg-cyan-400 border-[1.5px] border-cyan-300 rounded-2xl overflow-hidden shadow-[0_20px_40px_-12px_rgba(6,182,212,0.4)] transition-all hover:scale-[1.02] hover:shadow-[0_25px_50px_-12px_rgba(6,182,212,0.5)] flex items-center gap-3 active:scale-95"
>
